...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.yaml_path = None
        self.yaml_name = None
        self.yaml_name_text_label = None

        def openfile(yaml=False):
        ...
        def decode_clicked():
            ...
            if self.title_label.cget("text") != "Decode":
                try:
                    self.middle = customtkinter.CTkFrame(self)
                    self.middle.grid(row=1, column=1, padx=20, sticky="nsew")
                    ...
                    self.decode_middle_button_yaml = customtkinter.CTkButton(
                        ...
                        text_color=("gray10", "#DCE4EE"),
                        text="Insert Secrets",
                        command=lambda: [openfile(yaml=True), update_file_label(True)])
                    ...
                    self.decode_middle_button_submit = customtkinter.CTkButton(
                        ...
                        text_color=("gray10", "#DCE4EE"),
                        text="Submit",
                        command=lambda: [update_message_label(self.yaml_path, self.file_path)])
                    ...
                    self.image_name_text_label = customtkinter.CTkLabel(self.middle, text="Selected Image: ",
                                                                        font=customtkinter.CTkFont(size=16,
                                                                                                   weight="bold"))
                    self.image_name_text_label.grid(row=2, column=0, padx=20, pady=5)
                    self.image_name_text_label.place(rely=.89, x=4)

                    self.yaml_name_text_label = customtkinter.CTkLabel(self.middle, text="Selected Yaml: ",
                                                                       font=customtkinter.CTkFont(size=16,
                                                                                                  weight="bold"))
        ...
        # Decode button
        self.sidebar_button_3 = customtkinter.CTkButton(self.sidebar_frame, command=decode_clicked,
                                                        text="Decode")
